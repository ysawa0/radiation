...
%patient_ids=[56 57 58 60 62 63 65 67 68 69 70 71];
patient_ids = [31];
...
%             mysql(horzcat('UPDATE structure_set_roi_sequence SET Volume="',num2str(roiVolume),'" WHERE stdROIName = "',stdROINames{i},'" AND fk_patient_id="',num2str(patient_id),'"'));

            % Get a list of all the PTVs
            ptvs = mysql(horzcat('SELECT stdROIName FROM structure_set_roi_sequence WHERE stdROIName LIKE "ptv%" AND fk_patient_id = "',num2str(patient_id),'" ORDER BY stdROIName DESC'));
...
%                     mysql(horzcat('UPDATE structure_set_roi_sequence SET ',ptvName,' = "',ptvs{ptvIndex},'" WHERE fk_patient_id="',num2str(patient_id),'"'));
%                     mysql(horzcat('UPDATE structure_set_roi_sequence SET Volume="',num2str(ptvVolume),'" WHERE stdROIName = "',ptvs{ptvIndex},'" AND fk_patient_id="',num2str(patient_id),'"'));
%                     mysql(horzcat('UPDATE structure_set_roi_sequence SET DistanceMean_',ptvName,'="',num2str(roiMean),'", DistanceStdDev_',ptvName,'="',num2str(roiStandardDeviation),'", DistanceMode_',ptvName,'="',num2str(roiMode),'", DistanceSkewness_',ptvName,'="',num2str(roiSkewness),'", DistanceMedian_',ptvName,'="',num2str(roiMedian),'", DistanceMin_',ptvName,'="',num2str(roiMin),'", DistanceMax_',ptvName,'="',num2str(roiMax),'" WHERE id="',num2str(structure_set_roi_sequence_ids(i)),'"'));
%                     mysql(horzcat('UPDATE structure_set_roi_sequence SET OverlapVolume_',ptvName,'="',num2str(roiIntersectingVolume),'", PercentageOverlap_ROI_Fraction_',ptvName,'="',num2str(roiPercentageOverlap_OAR_Fraction),'", PercentageOverlap_Total_Fraction_',ptvName,'="',num2str(roiPercentageOverlap_Total_Fraction),'" WHERE id="',num2str(structure_set_roi_sequence_ids(i)),'"'));
%                     mysql(horzcat('UPDATE structure_set_roi_sequence SET ovhDistance_',ptvName,'="',roiOVH_distance,'", ovhVolume_',ptvName,'="',roiOVH_v,'" WHERE id="',num2str(structure_set_roi_sequence_ids(i)),'"'));
%                     mysql(horzcat('UPDATE structure_set_roi_sequence SET ovhComplete_',ptvName,' = "',ovhComplete,'" WHERE id="',num2str(structure_set_roi_sequence_ids(i)),'"'));
%                     mysql(horzcat('UPDATE structure_set_roi_sequence SET ',ptvName,'_ovh5=',num2str(ovhSetPoints{1}),', ',ptvName,'_ovh10=',num2str(ovhSetPoints{2}),', ',ptvName,'_ovh15=',num2str(ovhSetPoints{3}),', ',ptvName,'_ovh20=',num2str(ovhSetPoints{4}),', ',ptvName,'_ovh25=',num2str(ovhSetPoints{5}),', ',ptvName,'_ovh30=',num2str(ovhSetPoints{6}),', ',ptvName,'_ovh35=',num2str(ovhSetPoints{7}),', ',ptvName,'_ovh40=',num2str(ovhSetPoints{8}),', ',ptvName,'_ovh45=',num2str(ovhSetPoints{9}),', ',ptvName,'_ovh50=',num2str(ovhSetPoints{10}),', ',ptvName,'_ovh55=',num2str(ovhSetPoints{11}),', ',ptvName,'_ovh60=',num2str(ovhSetPoints{12}),', ',ptvName,'_ovh65=',num2str(ovhSetPoints{13}),', ',ptvName,'_ovh70=',num2str(ovhSetPoints{14}),', ',ptvName,'_ovh75=',num2str(ovhSetPoints{15}),', ',ptvName,'_ovh80=',num2str(ovhSetPoints{16}),', ',ptvName,'_ovh85=',num2str(ovhSetPoints{17}),', ',ptvName,'_ovh90=',num2str(ovhSetPoints{18}),', ',ptvName,'_ovh95=',num2str(ovhSetPoints{19}),', ',ptvName,'_ovh100=',num2str(ovhSetPoints{20}),' WHERE id="',num2str(structure_set_roi_sequence_ids(i)),'"'));
                end;
                counter=counter+1;
        else
            %mysql(horzcat('UPDATE structure_set_roi_sequence SET Volume="',num2str(ptvVolume),'" WHERE id="',num2str(structure_set_roi_sequence_ids(i)),'"'));
        end;
